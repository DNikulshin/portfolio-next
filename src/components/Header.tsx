...
export const Header = () => {
  return (
    <header className="w-full flex-col  items-center gap-4">
      ...
      <div className="flex justify-between items-center gap-4">
          ...
          <div className="flex gap-4 justify-center items-center  py-4">
            ...
            <ul className="flex flex-col gap-3 justify-center items-center">
              <li
                ...
                title="https://github.com/DNikulshin"
              >
                <Link
              ...
              <li
                className="px-1 py-0.5 shadow-md rounded-md hover:text-red-500/85"
                title="+7925-861-59-59"
              >
                <Link
                  href="tel:+7925-861-59-59"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="flex justify-center items-center">
          <div className="max-w-[150px] select-none pointer-events-none">
            <Image src={Notebook} alt="notebook" priority placeholder="blur" />
          </div>
        </div>
      </div>
    </header>
